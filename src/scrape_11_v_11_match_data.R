#function to return the basic data of a match
#teams, score, managers etc.
...
#function to transfer from the table of scraped data into useful data
munge_basic_data <- function(data) {

}

#function to grab the events in a match
#goals, yellow carrds, etc
